...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  BottomNavigationBar _buildBottomNavigationBar() {
    return BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.event), title: Text("Lịch")),
          BottomNavigationBarItem(icon: Icon(Icons.playlist_add_check), title: Text("Điểm Danh")),
          BottomNavigationBarItem(icon: Icon(Icons.filter_9), title: Text("Điểm")),
          BottomNavigationBarItem(icon: Icon(Icons.settings), title: Text("Cài đặt")),
        ]
    );
  }
